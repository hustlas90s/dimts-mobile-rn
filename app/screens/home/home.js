                        ...
                        <List.Accordion
                            ...
                            <View className="pl-6">
                                <Text
                                    ...
                                    className="text-md mb-2">
                                    The judge or magistrate is in charge of the
                                    court and everyone in the courtroom should
                                    show them respect.
                                </Text>
                                <Text
                                    style={{
                        ...
                        <List.Accordion
                            ...
                            <View className="pl-6">
                                <Text
                                    ...
                                    className="text-md mb-2">
                                    As a defendant it is very important that you
                                    show respect for the court and the judge. In
                                    the courtroom, you should stand whenever the
                                    judge or magistrate speaks to you.
                                </Text>
                            </View>
                        </List.Accordion>
                        <List.Accordion
                            ...
                            <View className="pl-6">
                                <Text
                                    ...
                                    className="text-md mb-2">
                                    You should wait outside the courtroom until
                                    you are called to give evidence. You
                                    shouldn’t talk to other witnesses about the
                                    case before you and they have given
                                    evidence.
                                </Text>
                            </View>
                        </List.Accordion>
                        <List.Accordion
                            ...
                            <View className="pl-6">
                                <Text
                                    ...
                                    className="text-md mb-2">
                                    As a juror, you can’t have a mobile phone or
                                    other tablet device in the court room, even
                                    if it’s turned off. There will also be times
                                    when you will not be able to retain your
                                    mobile devices, even in the jury room. The
                                    bailiff will be the person who will inform
                                    you of these times.
                                </Text>
                            </View>
                        </List.Accordion>
